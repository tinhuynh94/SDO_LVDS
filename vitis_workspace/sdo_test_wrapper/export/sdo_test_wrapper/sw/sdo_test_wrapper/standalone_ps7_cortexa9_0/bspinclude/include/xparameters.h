...
/* Definitions for peripheral EN_25MHZ_GPIO */
#define XPAR_EN_25MHZ_GPIO_BASEADDR 0x41220000
#define XPAR_EN_25MHZ_GPIO_HIGHADDR 0x4122FFFF
#define XPAR_EN_25MHZ_GPIO_DEVICE_ID 0
#define XPAR_EN_25MHZ_GPIO_INTERRUPT_PRESENT 0
#define XPAR_EN_25MHZ_GPIO_IS_DUAL 0


/* Definitions for peripheral LEV_SHIFT_OE_GPIO */
#define XPAR_LEV_SHIFT_OE_GPIO_BASEADDR 0x41230000
#define XPAR_LEV_SHIFT_OE_GPIO_HIGHADDR 0x4123FFFF
#define XPAR_LEV_SHIFT_OE_GPIO_DEVICE_ID 1
#define XPAR_LEV_SHIFT_OE_GPIO_INTERRUPT_PRESENT 0
#define XPAR_LEV_SHIFT_OE_GPIO_IS_DUAL 0
...
/* Canonical definitions for peripheral EN_25MHZ_GPIO */
#define XPAR_GPIO_0_BASEADDR 0x41220000
#define XPAR_GPIO_0_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_EN_25MHZ_GPIO_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral LEV_SHIFT_OE_GPIO */
#define XPAR_GPIO_1_BASEADDR 0x41230000
#define XPAR_GPIO_1_HIGHADDR 0x4123FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_LEV_SHIFT_OE_GPIO_DEVICE_ID
